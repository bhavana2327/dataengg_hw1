...
# The following functions have been removed from Max's code and added here to run main function
...
class main(object):
    ...
    def restclient_run(self):
        # The api key given by the professor
        # key = "beBybSi8daPgsTp5yx5cHtHpYcrjp5Jq"
        
        # the key is read from a file which the user can use to save the key
        # this adds the external security feature where thekey will not be visible
        # but can still be accessed by the code.
        ...
        self.initialize_raw_data_tables(engine,self.currency_pairs)
