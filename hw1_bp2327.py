...
# The main function performs client connection using Polygon API and writes the data into SQL table
# All the dependencies for main function have been copied into the library named run_client
# these function can be imported here, for the purpose of this homework only main function is 
# imported
from runclient import rest_script
...
rest_script.main(currency_pairs).restclient_run()
